...
import {
  storageAllImagesDisplay,
  storageAllImagesFiling,
  storageAllImagesPedestral,
} from "../Product-Category/Storage/storageImgSection";
...
const ProductDetailPage3 = () => {
  ...
  let productData;
  if (category === "filing-cabinet") {
    productData = storageAllImagesFiling;
  } else if (category === "pedestral-cabinet") {
    productData = storageAllImagesPedestral;
  } else if (category === "display-cabinet") {
    productData = storageAllImagesDisplay;
  }
