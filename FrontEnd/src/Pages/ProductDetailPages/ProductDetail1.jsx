...
import {
  deskAllImagesExecutive,
  deskAllImagesEconomic,
  deskAllImagesReception,
  deskAllImagesConference,
  deskAllImagesOffice,
  deskAllImagesCoffee,
} from "../Product-Category/Desk/deskImgSection";
...
const ProductDetailPage1 = () => {
  ...
  let productData;
  if (category === "executive-desk") {
    productData = deskAllImagesExecutive;
  } else if (category === "economic-desk") {
    productData = deskAllImagesEconomic;
  } else if (category === "reception-desk") {
    productData = deskAllImagesReception;
  } else if (category === "office-desk") {
    productData = deskAllImagesOffice;
  } else if (category === "conference-desk") {
    productData = deskAllImagesConference;
  } else if (category === "coffee-desk") {
    productData = deskAllImagesCoffee;
  }
