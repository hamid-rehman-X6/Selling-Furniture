...
import {
  chairAllImagesExecutive,
  chairAllImagesManager,
  chairAllImagesMeeting,
  chairAllImagesOperator,
} from "../Product-Category/Chair/chairImgSection";
...
const ProductDetailPage2 = () => {
  ...
  let productData;
  if (category === "executive-chair") {
    productData = chairAllImagesExecutive;
  } else if (category === "manager-chair") {
    productData = chairAllImagesManager;
  } else if (category === "operator-chair") {
    productData = chairAllImagesOperator;
  } else if (category === "meeting-chair") {
    productData = chairAllImagesMeeting;
  }
