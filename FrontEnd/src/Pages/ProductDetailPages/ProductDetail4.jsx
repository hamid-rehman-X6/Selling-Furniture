...
import {
  seatingAllImagesLounge,
  seatingAllImagesOfficeSofa,
} from "../Product-Category/Seating/seatingImgSection";
...
const ProductDetailPage4 = () => {
  ...
  let productData;
  if (category === "lounge") {
    productData = seatingAllImagesLounge;
  } else if (category === "office-sofa") {
    productData = seatingAllImagesOfficeSofa;
  }
...
export default ProductDetailPage4;
