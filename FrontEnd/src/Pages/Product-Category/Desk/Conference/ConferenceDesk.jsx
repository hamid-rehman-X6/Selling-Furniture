...
import { deskAllImagesConference } from "./../deskImgSection";
    ...
    <>
      ...
      <div className="p-6 bg-gray-100 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {deskAllImagesConference.map((desk) => (
            <Link
              to={`/product/desk/conference-desk/${desk.id}`}
              key={desk.id}
